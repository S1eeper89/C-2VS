...
using System.Linq;
    ...
    internal class Program
    {
            ...
            List<int> ruznaCisla = new List<int>()
        {
            ...
            // 2. Řešení
            List<int> nasobky4a6 = ruznaCisla.Where(r => r % 4 == 0 || r % 6 == 0).ToList();
            ...
            Console.WriteLine($"V seznamu ruznaCisla je {ruznaCisla.Count} cisel.");
